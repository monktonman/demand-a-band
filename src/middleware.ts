...
const betaBypassPaths = ["/beta", "/api/beta", "/_next", "/favicon.ico", "/api/spotify"];
  ...
  },
  {
    callbacks: {
      authorized: ({ token, req }) => {
        ...
        const publicPaths = ["/", "/login", "/register", "/api/auth", "/events", "/api/events", "/api/bands", "/bands", "/dream-show", "/api/dream-shows", "/beta", "/api/beta", "/api/spotify"];
