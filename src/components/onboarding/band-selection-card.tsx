...
export function BandSelectionCard({
  ...
  const showImage = band.imageUrl && !imgError;
  ...
  return (
    ...
    >
      {/* Selected checkmark */}
      {isSelected && (
        <div className="absolute right-2 top-2 z-10 flex h-5 w-5 items-center justify-center rounded-full bg-orange-600 shadow-sm">
      ...
      {/* Artist image or fallback icon */}
      {showImage ? (
        <div className={cn(
          "mb-2 h-12 w-12 overflow-hidden rounded-lg",
